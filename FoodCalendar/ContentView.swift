...
struct ContentView: View {
    ...
    @State private var foodItems: [FoodItem] = [
        ...
        FoodItem(name: "Sugar", imageName: "sugar", date: Calendar.current.date(from: DateComponents(year: 2025, month: 1, day: 10))!),
        ...
        FoodItem(name: "Honey", imageName: "honey", date: Calendar.current.date(from: DateComponents(year: 2025, month: 1, day: 10))!),
        FoodItem(name: "Chocolate", imageName: "chocolate", date: Calendar.current.date(from: DateComponents(year: 2025, month: 1, day: 10))!),
        ...
        FoodItem(name: "Olives", imageName: "olives", date: Calendar.current.date(from: DateComponents(year: 2025, month: 1, day: 9))!),
        ...
        FoodItem(name: "Spaghetti", imageName: "spaghetti", date: Calendar.current.date(from: DateComponents(year: 2025, month: 1, day: 10))!),
        ...
        FoodItem(name: "Rice", imageName: "rice", date: Calendar.current.date(from: DateComponents(year: 2025, month: 1, day: 10))!),
        ...
        FoodItem(name: "Cinnamon", imageName: "cinnamon", date: Calendar.current.date(from: DateComponents(year: 2025, month: 1, day: 10))!),
